...
function createComponent(Constructor, props) {
  ...
  if (Constructor.prototype && Constructor.prototype.render) {
    inst = new Constructor(props); // 如果是函数定义组件，则将其扩展为类定义组件
  } else {
...
},{"./dom":"src/react-dom/dom.js","./render":"src/react-dom/render.js"}],"src/react/set-state-queue.js":[function(require,module,exports) {
"use strict";
...
var setStateQueue = []; // 保存组件stateChange的队列
...
function flush() {
  var item, component; // 遍历保存了组件setState的队列

  while (item = setStateQueue.shift()) {
    // 出队列
    var _item = item,
        stateChange = _item.stateChange,
        _component = _item.component; // 组件改变的state和组件实例
...
/* 
    验证类组件
*/
var Conuter = /*#__PURE__*/function (_React$Component) {
  _inherits(Conuter, _React$Component);

  var _super = _createSuper(Conuter);
  ...
  function Conuter(props) {
    ...
    _this = _super.call(this, props); // 继承父组件的props 默认为{}

    _this.state = {
      // 继承父组件的state和setState方法
      count: 0
    };
    return _this;
  } // 验证生命周期
...
},{"./react":"src/react/index.js","./react-dom":"src/react-dom/index.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
